...
var signup = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, email, country, address, NID, phone, password, passwordConfirm) {
    var res;
  ...
  return function signup(_x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error logged out!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"sendEmail.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'email had sended!');
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"resetPass.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "https://craftshandmade.herokuapp.com/api/users/resetPassword/".concat(token),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'https://craftshandmade.herokuapp.com/api/users/updateMyPassword' : 'https://craftshandmade.herokuapp.com/api/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"products.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.search = exports.hideProduct = exports.editProduct = exports.deleteProduct = exports.addProduct = void 0;
...
var addProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, price, category, city, description, images, user) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            // console.log(images)
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Product Added');
            }
...
var editProduct = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(title, price, category, city, description, productId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "https://craftshandmade.herokuapp.com/api/products/".concat(productId),
              data: {
                title: title,
                price: price,
                category: category,
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Product Edited');
            }
  ...
  return function editProduct(_x8, _x9, _x10, _x11, _x12, _x13) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteProduct = /*#__PURE__*/function () {
  ...
  return function deleteProduct(_x14) {
    return _ref3.apply(this, arguments);
  };
}();
...
var hideProduct = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(productId, available) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "https://craftshandmade.herokuapp.com/api/products/hide/".concat(productId),
              data: {
                available: available
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alerts.showAlert)('success', "Available ".concat(available));
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function hideProduct(_x15, _x16) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'get',
              url: "https://craftshandmade.herokuapp.com/api/products/search/".concat(title)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                location.assign("/search/".concat(title));
              }, 500);
            }
...
var addReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productId, review) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "https://craftshandmade.herokuapp.com/api/products/".concat(productId, "/reviews"),
              data: {
                review: review
              }
            });
  ...
  return function addReview(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'delete',
              url: "https://craftshandmade.herokuapp.com/api/reviews/".concat(reviewId)
            });
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"orders.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.visaOrder = exports.onDeliveryOrder = exports.deleteOrder = exports.addOrder = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            // console.log(images)
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Order Added');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "https://craftshandmade.herokuapp.com/api/orders/".concat(orderId)
            });
          ...
          case 3:
            ...
            // console.log(images)
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Order Deleted');
            }
...
var onDeliveryOrder = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(city, address, floorNum, flatNum, phone) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            // console.log(images)
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Order is Coming');
            }
  ...
  return function onDeliveryOrder(_x3, _x4, _x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();

exports.onDeliveryOrder = onDeliveryOrder;

var visaOrder = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            stripe = Stripe('pk_test_51LL50zElw5uFGOXXnizDp2FbezKtY8UD9AJ9dtC0hjfTxUTgJKq2yg175tvbOv53VNQkDPV9xBN3kipWcsyC3G4t00Nwdo5lSZ');
            _context4.prev = 1;
            _context4.next = 4;
            return (0, _axios.default)("https://craftshandmade.herokuapp.com/api/orders/checkout");
  ...
  return function visaOrder() {
    return _ref4.apply(this, arguments);
  };
}();

exports.visaOrder = visaOrder;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"allCart.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "https://craftshandmade.herokuapp.com/api/users/cart-delete/".concat(productId)
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'sended');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
...
var forgotPassword = document.querySelector('.forgot-password-form');
var resetPass = document.querySelector('.token');
...
var editProductBtn = document.querySelector('.editProductBtn');
var deleteProductBtn = document.querySelector('.deleteProductBtn');
var hideProductBtn = document.querySelector('.hideProductBtn');
var addReviewBtn = document.querySelector('.addReviewBtn');
var deleteReviewBtn = document.querySelector('.deleteReviewBtn');
var deleteOrderBtn = document.querySelector('.deleteOrderBtn');
var addToCartBtn = document.querySelector('.addToCart');
var removeFromCartBtn = document.querySelector('.remove');
var visaOrderBtn = document.querySelector('.checkoutOrder');
var onDeliveryForm = document.querySelector('.form-cart');
var sendproblem = document.querySelector('.text');
if (loginForm) loginForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('login_email').value;
  var password = document.getElementById('login_password').value;
  (0, _register.login)(email, password);
});
if (signupForm) signupForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('signup_name').value;
  var email = document.getElementById('signup_email').value;
  var country = document.getElementById('signup_country').value;
  var address = document.getElementById('signup_address').value;
  var NID = document.getElementById('signup_NID').value;
  ...
  (0, _register.signup)(name, email, country, address, NID, phone, password, passwordConfirm);
});
if (logOutBtn) logOutBtn.addEventListener('click', _register.logout);
...
if (forgotPassword) forgotPassword.addEventListener('submit', function (e) {
  ...
  (0, _sendEmail.sendEmail)(email);
});
if (resetPass) resetPass.addEventListener('click', function (e) {
  e.preventDefault();
  var token = e.target.dataset.token;
  var password = document.getElementById('pass-reset').value;
  var passwordConfirm = document.getElementById('passCon-reset').value;
  (0, _resetPass.resetPassword)(token, password, passwordConfirm);
});
...
if (addProductBtn) {
  addProductBtn.addEventListener('click', function (e) {
    ...
    (0, _products.addProduct)(title, price, category, city, description, image1, image2, image3, image4, user);
  });
}
...
if (editProductBtn) {
  editProductBtn.addEventListener('click', function (e) {
    ...
    var category = document.getElementById('category').value;
    var city = document.getElementById('country').value;
    var description = document.getElementById('description').value; // const images =  document.getElementById('image1').files[0];

    var productId = e.target.dataset.productId;
    (0, _products.editProduct)(title, price, category, city, description, productId);
  });
}
...
if (deleteProductBtn) {
  deleteProductBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var productId = e.target.dataset.productId;
    (0, _products.deleteProduct)(productId);
  });
}

if (hideProductBtn) {
  hideProductBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var productId = e.target.dataset.productId;
    var available = e.target.dataset.available;
    (0, _products.hideProduct)(productId, available);
  });
}
...
if (addReviewBtn) addReviewBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var productId = e.target.dataset.productId;
  var review = document.getElementById('bodyText').value;
  (0, _reviews.addReview)(productId, review);
});
if (deleteReviewBtn) deleteReviewBtn.addEventListener('click', function (e) {
  e.preventDefault();
